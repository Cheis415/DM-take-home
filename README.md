Thank you so much for the opportunity! I hope that the code is clean and legible. Let me know if you have any questions.
...
5.  You can run the backend by cd'ing into the backend folder located in the utils folder.
